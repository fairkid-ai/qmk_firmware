...
*/
    [L_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B,    KC_LBRC,          KC_RBRC,        KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_MINS,
                    _______, KC_LALT, KC_LGUI,    KC_SPACE,         KC_ENTER,       _______, _______, _______
    ),
    [L_SYMBOLS] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, KC_AT, KC_LABK, KC_RABK, KC_HASH, KC_PERC, KC_PIPE, KC_COLN, KC_LCBR, KC_RCBR, KC_GRAVE, _______,
        _______, KC_EXLM, KC_MINUS, KC_PLUS, KC_EQUAL, KC_DQUO, KC_AMPR, KC_UNDS, KC_LPRN, KC_RPRN, KC_CIRC, _______,
    ...
    [L_MACSYS] = LAYOUT(
	    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, MEH(KC_Z), MEH(KC_F9), MEH(KC_F8), MEH(KC_F7), MEH(KC_F12), _______, RALT(KC_S), ST_MACRO_UNDO,  LCTL(LALT(KC_J)), ST_MACRO_LANG,  _______,
    _______, MEH(KC_Y), MEH(KC_F6), MEH(KC_F5), MEH(KC_F4), MEH(KC_F11), _______, ST_MACRO_GOTO,     ST_MACRO_SWITCH_BUF,     ST_MACRO_OPEN_FILE,     ST_MACRO_SAVE_FILE,    _______,
    _______, MEH(KC_X), MEH(KC_F3), MEH(KC_F2), MEH(KC_F1), MEH(KC_F10),  _______, _______, _______, ST_MACRO_QR,    ST_MACRO_MARK_BUF,    ST_MACRO_KILL_BUF,    ST_MACRO_JOIN_LINE,    _______,
	KC_SYSTEM_SLEEP, KC_PWR, DM_PLY2, DM_PLY1, DM_REC1, DM_REC2, DM_RSTP, _______
	),
      [L_MEDIA] = LAYOUT(
	_______, _______, _______, _______, _______, _______,
	_______, _______, _______, _______, _______, _______,
    ...
    [L_ONEHAND] = LAYOUT(
	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
	_______, KC_WWW_FORWARD, KC_HOME, KC_WH_U, KC_END, ST_MACRO_ZOOMOUT, _______, _______, _______, _______, _______, _______,
	_______, KC_WWW_BACK, KC_BTN3, KC_BTN1, KC_BTN2, ST_MACRO_ZOOMIN, _______, _______, _______, _______, _______, _______,
	_______, KC_WWW_HOME, KC_PGUP, KC_WH_D,    KC_PGDN, ST_MACRO_ZOOM_RESET, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______
	),
};
